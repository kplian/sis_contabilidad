...
select conta.f_import_tdetalle_plantilla_comprobante ('insert','NOTACREDITODOC','NOTACREDITO.3','haber','no','si','','','CMRETGARDF','','{$tabla.importe_retgar}','','','no','','{$tabla.id_auxiliar}','','si','','id_agrupador','','retencion de garantia','{$tabla.importe_retgar}',NULL,'simple','','{$tabla.id_doc_compra_venta}','no','','','','','','','','2','','conta.vdoc_compra_venta',NULL,'','','','','',NULL);
select conta.f_import_tdetalle_plantilla_comprobante ('insert','NOTACREDITODOC','NOTACREDITO.2','haber','no','si','','','CMPDEF','','{$tabla.importe_pago_liquido}','','','no','','','','si','','id_agrupador','','cuenta para bancos','{$tabla.importe_pago_liquido}',NULL,'simple','','{$tabla.id_doc_compra_venta}','no','','','','','','','','2','','conta.vdoc_compra_venta',NULL,'','','','','',NULL);
select conta.f_import_tdetalle_plantilla_comprobante ('insert','NOTACREDITODOC','NOTACREDITO.4','haber','no','si','','','CMRETANTD','','{$tabla.importe_anticipo}','','','no','','{$tabla.id_auxiliar}','','si','','id_agrupador','','retención de anticipos','{$tabla.importe_anticipo}',NULL,'simple','','{$tabla.id_doc_compra_venta}','no','','','','','','','','2','','conta.vdoc_compra_venta',NULL,'','','','','',NULL);
select conta.f_import_tdetalle_plantilla_comprobante ('insert','NOTACREDITODOC','NOTACREDITO.5','haber','no','si','','','CXPDEV','','{$tabla.importe_pendiente}','{$tabla.id_proveedor}','','no','','{$tabla.id_auxiliar}','','si','','id_agrupador','','cuentas por pagar','{$tabla.importe_pendiente}',NULL,'simple','','{$tabla.id_doc_compra_venta}','no','','','','','','','','2','','conta.vdoc_compra_venta_proveedor',NULL,'','','','','','{$tabla.codigo_aplicacion}');
...
select conta.f_import_tdetalle_plantilla_comprobante ('insert','NOTADEBITODOC','NOTADEBITO.2','debe','si','si','','','VENDEF','','{$tabla.importe_pago_liquido}','','','no','','','','si','','id_agrupador','','ingreso a bancos','{$tabla.importe_pago_liquido}',NULL,'simple','','{$tabla.id_doc_compra_venta}','no','','','','','','','','2','','conta.vdoc_compra_venta',NULL,'','','',''todos','',NULL);
...
select conta.f_import_tdetalle_plantilla_comprobante ('insert','DEVTESPROV','DEVTESPROV2','debe','si','si','','{$tabla.descripcion}','PAGOANT','','{$tabla_padre.monto_anticipo}','{$tabla_padre.id_proveedor}','{$tabla_padre.id_plantilla}','si','{$tabla.id_centro_costo}','','','si','','','','Anticipo proveedores','{$tabla_padre.monto_anticipo}',NULL,'simple','','','no','','','','','','{$tabla_padre.porc_monto_excento_var}','','2','','',NULL,'','','','','todos','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','DEVTESPROV','DEVTESPROV1','haber','si','si','','','CUENDEVPRO','','{$tabla_padre.descuento_anticipo}','{$tabla_padre.id_proveedor}','','no','','','','si','','','','Suma el descuento de anticipo a proveedor por pagar','{$tabla_padre.descuento_anticipo}',NULL,'simple','','','no','','','','','','','','2','','',NULL,'','','','','todos','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','DEVTESPROV','x3','debe','si','si','','{$tabla.descripcion}','CUECOMP','','{$tabla.monto_pago_mo}','{$tabla.id_concepto_ingas}','{$tabla_padre.id_plantilla}','si','{$tabla.id_centro_costo}','','','si','','id_plan_pago','{$tabla.id_partida_ejecucion_com}','Concepto de Gasto','{$tabla.monto_pago_mo}',NULL,'simple','tes.f_conta_act_tran_plan_pago_dev','{$tabla.id_prorrateo}','no','','','','','','{$tabla_padre.porc_monto_excento_var}','','2','{$tabla.id_orden_trabajo}','tes.vcomp_devtesprov_det_plan_pago',NULL,'','','','','no_descuento','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','DEVTESPROV','x','haber','si','si','','','CUENDEVPRO','','{$tabla_padre.otros_descuentos}','{$tabla_padre.id_proveedor}','','no','','','','no','','','','Suma la multa a la cuenta de proveedores por pagar','{$tabla_padre.otros_descuentos}','2','simple','','','no','','','','','','','','2','','','CXP','','','',NULL,'todos',NULL);
select conta.f_import_tdetalle_plantilla_comprobante ('insert','DEVTESPROV','CXP','haber','si','si','','','CUENDEVPRO','','select  COALESCE({$tabla_padre.liquido_pagable}) + COALESCE({$tabla_padre.descuento_inter_serv})+ COALESCE({$tabla_padre.descuento_ley})+ COALESCE({$tabla_padre.monto_retgar_mo})','{$tabla_padre.id_proveedor}','','no','','','','no','','','','Proveedor por pagar','select  COALESCE({$tabla_padre.liquido_pagable}) + COALESCE({$tabla_padre.descuento_inter_serv})+ COALESCE({$tabla_padre.descuento_ley})+ COALESCE({$tabla_padre.monto_retgar_mo})','1','simple','','','no','','','','','','','','2','','','x3','','','','','todos','');
...
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PAGTESPROV','PAGTESPROV1','haber','si','si','','','RETINSER','','{$tabla_padre.descuento_inter_serv}','{$tabla_padre.id_proveedor}','','no','','','','si','','','','Descuento por intercambio de servicios','{$tabla_padre.descuento_inter_serv}',NULL,'simple','','','no','','','','','','','','2','','',NULL,'','','','','todos','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PAGTESPROV','PAGTESPROV2','haber','si','si','','{$tabla_padre.nombre_pago}','CUEBANCEGRE','','{$tabla_padre.liquido_pagable}','{$tabla_padre.id_cuenta_bancaria}','','no','','','','si','','','','Cuenta Bancaria','{$tabla_padre.liquido_pagable}',NULL,'simple','','','no','','{$tabla_padre.id_cuenta_bancaria}','{$tabla_padre.id_cuenta_bancaria_mov}','{$tabla_padre.nro_cheque}','{$tabla_padre.nro_cuenta_bancaria}','{$tabla_padre.porc_monto_excento_var}','{$tabla_padre.nombre_pago}','2','','',NULL,'{$tabla_padre.forma_pago}','','','','todos','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PAGTESPROV','RET.1','haber','si','si','','','RETANT','','{$tabla_padre.descuento_anticipo}','{$tabla_padre.id_proveedor}','','no','','','','si','','','','Retencion de anticipo','{$tabla_padre.descuento_anticipo}',NULL,'simple','','','no','','','','','','','','2','','',NULL,'','','','','todos','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PAGTESPROV','CXP','debe','si','si','','','CUENPAGPRO','','select COALESCE({$tabla_padre.monto},0)   ','{$tabla_padre.id_proveedor}','{$tabla_padre.id_plantilla}','si','','','','si','','','','Cuenta de proveedores por pagar','select COALESCE({$tabla_padre.monto},0)    ',NULL,'simple','','','no','','','','','','','','2','','',NULL,'','','','','descuento','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PAGTESPROV','x2','haber','si','si','','','CUENMULPRO','','{$tabla_padre.otros_descuentos}','{$tabla_padre.id_proveedor}','','no','','','','si','','','','otras descuentos proveedor','{$tabla_padre.otros_descuentos}',NULL,'simple','','','no','','','','','','','','2','','',NULL,'','','','','todos','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PAGTESPROV','REGAR','haber','si','si','','','CUENRETGARPRO','','{$tabla_padre.monto_retgar_mo}','{$tabla_padre.id_proveedor}','','no','','','','si','','','','retencion de garantia','{$tabla_padre.monto_retgar_mo}',NULL,'simple','','','no','','','','','','','','2','','',NULL,'','','','','todos','');
