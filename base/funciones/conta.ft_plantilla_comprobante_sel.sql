	...
	if(p_transaccion='CONTA_CMPB_SEL')then
    	...
    	begin
			...
			v_consulta:='select
						...
						cmpb.comprobante_eliminado,
						cmpb.id_tabla,
						cmpb.subistema,
						cmpb.descripcion,
						cmpb.comprobante_controlado,
						cmpb.fecha,
						cmpb.estado_reg,
						cmpb.acreedor,
						cmpb.depto,
...
COST 100;
ALTER FUNCTION "conta"."ft_plantilla_comprobante_sel"(integer, integer, character varying, character varying) OWNER TO postgres;
