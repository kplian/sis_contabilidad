...
/**************************************************************************
 ...
 FUNCION: 		conta.f_plantilla_cierre_ingreso
...
***************************************************************************
 ...
 ISSUE 		   FECHA   			 AUTOR				    DESCRIPCION:
  #4       20/12/2018    Miguel Mamani     Plantilla de Cierre de ingreso
...
BEGIN
v_nombre_funcion = 'conta.f_plantilla_cierre_ingreso';
...
select
    ...
    where id_int_comprobante = p_id_int_comprobante;
      ...
      FOR v_record_mov in (with basica as (select 	t.id_cuenta,
                                              ...
                                              where cb.estado_reg = 'validado'  and tc.tipo_cuenta in ('ingreso')
                    ...
                    IF v_sw_actualiza THEN
                        ...
                        v_importe_haber_mt = 0;
                         ...
                         IF v_record_mov.acreedor =v_record_mov.deudor and 
                           ...
                           ELSEIF  v_sw_saldo_acredor THEN
                  ...
                  IF v_saldo_mb != 0  or  v_saldo_ma != 0 or v_saldo_mt != 0 THEN
                        ...
                        insert into conta.tint_transaccion(
                                    ...
                                    'Asiento de Cierre de las Cuentas de Ingreso ',
