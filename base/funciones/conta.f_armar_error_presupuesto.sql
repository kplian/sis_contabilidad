...
#89             13/01/2020          RAC               Mejora de manejo de errores por bloqueo presupuestario de tipos de centros de costos no operativos #
*/
  ...
  --  recuperamos datos del presupuesto
            ...
            IF p_resp_ges[6]  != 1  THEN
             ...
             ELSE
               ...
               v_mensaje_error =  format('<BR/> Bloqueado --> %s',  v_codico_cc::varchar);
