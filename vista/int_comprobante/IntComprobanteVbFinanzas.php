...
?>
<script>
Phx.vista.IntComprobanteVbFinanzas = {
    bedit: true,
    bnew: false,
    bsave: false,
    bdel: true,
	...
	title: 'Libro Diario',
	nombreVista: 'IntComprobanteVbFinanzas',
	...
	constructor: function(config) {
        ...
        Phx.vista.IntComprobanteVbFinanzas.superclass.constructor.call(me,config);
	...
	preparaMenu : function(n) {
            ...
            this.getBoton('btnSwEditble').enable();
            
            
			return tb;
	},
	liberaMenu : function() {
			var tb = Phx.vista.IntComprobanteVbFinanzas.superclass.liberaMenu.call(this);
