...
Phx.vista.Transaccion=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
		...
		},
			{
				...
				type:'TextField',
				filters:{pfiltro:'contra.estado_reg',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
			{
				...
				type:'TextField',
				filters:{pfiltro:'contra.descripcion',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
			{
				...
				type:'DateField',
				filters:{pfiltro:'contra.fecha_reg',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
		...
		},
		{
		...
		},
			{
				...
				type:'DateField',
				filters:{pfiltro:'contra.fecha_mod',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		}
	...
	onReloadPage : function(m) {
			this.maestro = m;
			this.Atributos[1].valorInicial = this.maestro.id_comprobante;
			
			this.store.baseParams = {
				id_comprobante : this.maestro.id_comprobante
			};
			this.load({
				params : {
					start : 0,
