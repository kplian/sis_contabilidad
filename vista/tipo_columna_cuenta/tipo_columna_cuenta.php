...
?>
<script>
Phx.vista.TipoColumnaCuenta = {
	require:'../../../sis_planillas/vista/tipo_columna/TipoColumna.php',
	requireclase:'Phx.vista.TipoColumna',
	title:'Tipo Columna',
	constructor: function(config) {
		this.initButtons=[this.cmbTipoPlanilla];
		this.cmbTipoPlanilla.on('select',this.capturaFiltros,this);  
    	Phx.vista.TipoColumnaCuenta.superclass.constructor.call(this,config);    	
	},    
	east : { 
          ...
          params:{nombre_tabla:'plani.ttipo_columna',tabla_id : 'id_tipo_columna'}
   },
   capturaFiltros:function(combo, record, index){	
   		this.store.baseParams.compromete = "si"; 	
