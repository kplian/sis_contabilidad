...
*@description   Registro de facturas de ventas reularizacion en gestion anteriores para jutificar cobros y notas de credito debito
*
*/
header("content-type: text/javascript; charset=UTF-8");
?>
<script>
Phx.vista.DocVentaRegul= {
    tipoDoc: 'venta',
	require: '../../../sis_contabilidad/vista/doc_compra_venta/DocCompraVenta.php',
	requireclase: 'Phx.vista.DocCompraVenta',
	title: 'Regitro d Ventas gestion anteriores',
	nombreVista: 'DocVentaRegul',
	formTitulo: 'Formulario de Documento Venta',
	
	
   constructor: function(config) {
	    Phx.vista.DocVentaRegul.superclass.constructor.call(this,config);
    ...
    loadValoresIniciales: function() {
    	Phx.vista.DocVentaRegul.superclass.loadValoresIniciales.call(this);
        //this.Cmp.tipo.setValue(me.tipoDoc); 
        
   },
   capturaFiltros:function(combo, record, index){
        this.store.baseParams.tipo = this.tipoDoc;
        Phx.vista.DocVentaRegul.superclass.capturaFiltros.call(this,combo, record, index);
    },
