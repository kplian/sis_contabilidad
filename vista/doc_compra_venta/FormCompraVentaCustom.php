...
?>
<script>
    Phx.vista.FormCompraVentaCustom=Ext.extend(Phx.frmInterfaz,{
        ActSave:'../../sis_tesoreria/control/PlanPagoDocCompra/insertarDocCompleto',
        tam_pag: 10,
        tabEnter: true,
        codigoSistema: 'ADQ',
        ...
        iniciarEventos: function(){
            ...
            this.Cmp.nro_autorizacion.on('change',function(fild, newValue, oldValue){
                if (newValue[3] == '4' || newValue[3] == '8'|| newValue[3] == '6'|| newValue[3] == '6'|| newValue[3] == '7'){
                    this.mostrarComponente(this.Cmp.codigo_control);
            ...
            if(me.regitrarDetalle == 'si'){
                ...
                if( i > 0 &&  !this.editorDetail.isVisible()){
                    ...
                    if ((total_det.toFixed(2)*1) == this.Cmp.importe_doc.getValue()){
                        Phx.vista.FormCompraVentaCustom.superclass.onSubmit.call(this, o, undefined, true);
                    }
                    else{
