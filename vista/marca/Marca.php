...
Phx.vista.Marca=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'mar.descripcion',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
	...
	tam_pag:50,	
	title:'marca de comprobante',
	ActSave:'../../sis_contabilidad/control/Marca/insertarMarca',
	ActDel:'../../sis_contabilidad/control/Marca/eliminarMarca',
	ActList:'../../sis_contabilidad/control/Marca/listarMarca',
	id_store:'id_marca',
	fields: [
