...
#2     CONTA 	ETR    		19/12/2018		Miguel Mamani	reporte proyectos excel
#92 	CONTA 	ETR	 		19/12/2018		Miguel Mamani	actualización reporte de detalle de auxiliares
#5		CONTA 	ETR			24/12/2018		Manuel Guerra	Correcion de sumas en axuiliares
...
#111		    ETR            20/03/2020			MMV		Correcion de reporte detalle comprobante transacción
 ****************************************************************************
 */
...
class ACTIntTransaccion extends ACTbase{
    ...
    function reporteProyecto()
    {
        ...
        //Inicio #154: se agregan los parámetros básicos
        //Parámetros básicos
        $tamano = 'LETTER';
        $orientacion = 'L';
        $titulo = 'Proyectos';
