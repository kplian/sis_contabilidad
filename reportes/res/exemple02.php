...
<img src="./../../../sis_contabilidad/reportes/res/logo.gif" alt="logo" style="width: XXXmm"><br>
...
<page style="font-size: 10pt">
    ...
    <table style="width: 50%;border: solid 3px #5544DD" align="center">
        <tr>
            ...
            <td style="width: 40%; text-align: center;"><img src="./../../../sis_contabilidad/reportes/res/logo.gif" alt="" ><br><i>légende</i></td>
    ...
    texte à la suite d'une image, <img src="./../../../sis_contabilidad/reportes/res/logo.gif" alt="" style="height: 10mm">
