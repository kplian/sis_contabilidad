        ...
        if($this->objParam->getParametro('tipo') != 'oficial') {
            if ($this->cabecera[0]['id_moneda'] == $this->cabecera[0]['id_moneda_base']) {
                ...
                <tr>
                    ...
                    <td width="33%" colspan="2" align="center" class="td_currency">
                        <span><b><?php echo $this->cabecera[0]['desc_moneda']; ?></b></span></td>
                    <td width="22%" colspan="2" align="center" class="td_currency">
                        <span><b><?php echo $this->cabecera[0]['codigo_moneda_base']; ?></b></span></td>
                </tr>
                <tr>
